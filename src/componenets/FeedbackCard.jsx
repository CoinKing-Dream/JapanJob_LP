  ...
  return (
    <>
      <div className="shadow-lg shadow-cyan-500/100 w-[400px] h-[300px] relative border-2 rounded-lg">
        ...
        ></img>
        <div className="flex w-[400px] h-[300px] z-100 items-center justify-center text-black-500 absolute top-0 text-center duration-500 hover:bg-gray-800 hover:text-white hover:cursor-pointer hover:opacity-80">
